...
SAMPLE = """This is a bad sentnence with a typo. This is a very very long sentence """ + \                 "that will be flagged by the spaCy rule because it contains many tokens """ + \                 "and keeps going to reach the threshold."""        
